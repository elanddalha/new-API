...
async def webhook(request: Request):
    try:
        ...
        # ✅ Gemini API 호출 (기존 코드 유지, 프롬프트만 추가)
        ...
        prompt_text = (
            ...
            "예를 들어, '몇살이야?', '너 누구야?' 같은 질문에는 '퇴직연금과 투자 관련된 질문을 해주시면 성심껏 답변해 드리겠습니다.'라고 답변해. "
            "일반적인 질문을 하더라도 '퇴직연금'과 '투자' 관련 질문으로 인식해줘. "
            "예를 들어 '가입 어떻게 해?'라는 질문이 들어오면 '퇴직연금 가입 어떻게 해?'로 이해하면 돼. "
            "답변하기 어려운 내용은 이랜드투자자문에 전화하거나 메일 상담을 안내해. 간단하게 답변할 수 있는 건 너가 다 하고, 어려운 것만 넘겨야 돼. 너무 자주 메일 알려주지는 마."
